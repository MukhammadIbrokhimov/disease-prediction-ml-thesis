\begin{titlepage}
    ...
    \begin{flushleft}
        \hspace{3cm}
        \begin{tabular}{@{}ll}
            \textbf{Author:}             & Mukhammadsidik Ibrokhimov \\[0.3cm]
            \textbf{Matriculation No:}   & 55094865 \\[0.3cm]
            \textbf{First Supervisor:}   & Prof. Dr. Iftikhar Ahmed \\[0.3cm]
            \textbf{Second Supervisor:}  & Dr. Sami ur Rahman \\[0.3cm]
